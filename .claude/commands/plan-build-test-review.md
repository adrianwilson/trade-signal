...
- Set review_findings: count of issues found by /review (critical + informational)
- Set scope_drift: 1 if unplanned changes were needed outside the spec, 0 if clean

## Report

Summarize: issue classification, branch, spec file, test results, review results, PR URL, KPI summary.
